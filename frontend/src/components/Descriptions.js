                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12 text-center">
                            <h2 className="text-white">Join in on the conversation today!</h2>
                            ...
                            {/* <Link to="" className="btn btn-bg-white margin-t-30 waves-effect waves-light mb-5">View Plans & Pricing</Link> */}
                        </div>
                    </div>
                </div>
